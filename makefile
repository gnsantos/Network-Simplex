...
simplex.o: simplex.c grafo.c
	gcc-4.6 -Wall -ansi -pedantic -c -O2 simplex.c -lm
lerEntrada.o: lerEntrada.c grafo.c
	gcc-4.6 -Wall -ansi -pedantic -c -O2 lerEntrada.c -lm
arvore.o: arvore.c
	gcc-4.6 -Wall -ansi -pedantic -c -O2 arvore.c -lm
grafo.o: grafo.c
	gcc-4.6 -Wall -ansi -pedantic -c -O2 grafo.c -lm
clean:
	rm *.o *~
